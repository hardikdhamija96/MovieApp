...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    let url = `https://api.themoviedb.org/3/movie/${params.id}?api_key=ae69d47404f057e1066a811cf514f16e`;
  ...
  if (!movie)
    return (
      <div role="status">
        <svg
          aria-hidden="true"
          class="w-8 h-8 text-gray-00 animate-spin dark:text-gray-600 fill-blue-600"
          viewBox="0 0 100 101"
          fill="none"
