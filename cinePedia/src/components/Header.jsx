...
export const Header = () => {
  ...
  const activeClass =
    "block py-2 px-3 text-white bg-gray-700 rounded md:bg-transparent md:text-gray-500 md:font-bold md:p-0 md:dark:text-gray-400";
  const inActiveClass =
    "block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-700 md:p-0 md:dark:hover:text-gray-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700";
      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link
            ...
            <img src={logo} className="h-14" alt="CinePedia Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
              CinePedia
            </span>
          </Link>

          <div className="flex md:order-2" id="mobile-icons">
            <button
